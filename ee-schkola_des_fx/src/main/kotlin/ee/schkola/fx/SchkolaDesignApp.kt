...
open class SchkolaDesignApp() :
        ModelApp(ExplorerModel("SchkolaDesign", listOf("Component" to Schkola.initObjectTrees())) {
            it is MultiHolder<*, *>
        }, taskRepository())
/*
{
...
private fun taskRepository(): TaskRepository {
    ...
    val maven = Maven(home = home.resolve("maven"), plugins = arrayListOf("eclipse"), defaultProfiles = listOf(),
