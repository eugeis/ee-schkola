...
func NewPersonEventhorizonInitializer(eventStore eventhorizon.EventStore, eventBus eventhorizon.EventBus, eventPublisher eventhorizon.EventPublisher, 
    ...
    churchAggregateInitializer := NewAggregateInitializer(eventStore, eventBus, eventPublisher, commandBus, readRepos)
    graduationAggregateInitializer := NewAggregateInitializer(eventStore, eventBus, eventPublisher, commandBus, readRepos)
    profileAggregateInitializer := NewAggregateInitializer(eventStore, eventBus, eventPublisher, commandBus, readRepos)
