...
func NewExpenseQueryRepository() (ret *ExpenseQueryRepository) {
...
func NewExpensePurposeQueryRepository() (ret *ExpensePurposeQueryRepository) {
...
func NewFeeQueryRepository() (ret *FeeQueryRepository) {
...
func NewFeeKindQueryRepository() (ret *FeeKindQueryRepository) {
