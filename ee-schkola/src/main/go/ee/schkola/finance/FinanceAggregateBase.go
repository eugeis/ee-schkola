...
func NewFinanceEventhorizonInitializer(eventStore eventhorizon.EventStore, eventBus eventhorizon.EventBus, eventPublisher eventhorizon.EventPublisher, 
    ...
    expenseAggregateInitializer := NewAggregateInitializer(eventStore, eventBus, eventPublisher, commandBus, readRepos)
    expensePurposeAggregateInitializer := NewAggregateInitializer(eventStore, eventBus, eventPublisher, commandBus, readRepos)
    feeAggregateInitializer := NewAggregateInitializer(eventStore, eventBus, eventPublisher, commandBus, readRepos)
    feeKindAggregateInitializer := NewAggregateInitializer(eventStore, eventBus, eventPublisher, commandBus, readRepos)
